...
if [[ "$CHOICE" == "<< Back"* ]] || [[ -z "$CHOICE" ]]; then
  ...
  case "$INSTALLER" in
  "dev-editor") INSTALLER_FILE="$OMAKARCH_PATH/bin/omakarch-sub/install-dev-editor.sh" ;;
  "web-apps") INSTALLER_FILE="$OMAKARCH_PATH/install/desktop/optional/select-web-apps.sh" ;;
  ...
  "tailscale") INSTALLER_FILE="$OMAKARCH_PATH/install/terminal/optional/app-tailscale.sh" ;;
  "geekbench") INSTALLER_FILE="$OMAKARCH_PATH/install/terminal/optional/app-geekbench.sh" ;;
