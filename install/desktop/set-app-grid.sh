...
# Create folders
gsettings set org.gnome.desktop.app-folders folder-children "['Utilities', 'Sundry', 'YaST', 'Updates', 'Xtra', 'OnlyOffice']"
...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/OnlyOffice/ name 'OnlyOffice'
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/OnlyOffice/ apps "['onlyoffice-base.desktop', 'onlyoffice-calc.desktop', 'onlyoffice-draw.desktop', 'onlyoffice-impress.desktop', 'onlyoffice-math.desktop', 'onlyoffice-startcenter.desktop', 'onlyoffice-writer.desktop', 'onlyoffice-xsltfilter.desktop']"
